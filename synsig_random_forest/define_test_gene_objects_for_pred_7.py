...
#sys.path.append("~/Documents/Synapse_Ontology/no_brain_features_pipeline/no_brain_features")

#from define_gene_objects_rf_5 import *
...
def find_input_features(filename, input_genes):
	...
	if filename not in string_files:
		...
		df=pd.read_csv('../../brain_RNA_big_gene_pool_pipeline/normalized_features/normalized_%s.csv'%filename)
		...
		df = pd.read_csv('../../brain_RNA_big_gene_pool_pipeline/normalized_features/normalized_%s.csv'%filename,converters={"Interactors": lambda x: x.strip("[]").split(", ")})
...
if __name__ == '__main__':
	...
	#training_file='/Users/karenmei/Documents/Synapse_Ontology/NetworkClass/Entry_Ontology/synapse_10/input_genes/training_genes_0.csv'
	#training_file='training_genes_0.csv'
	#test_file='/Users/karenmei/Documents/Synapse_Ontology/NetworkClass/Entry_Ontology/synapse_10/input_genes/test_genes_0.csv'
	#test_file='test_genes_0.csv'

	#training_genes = get_training_gene_names(training_file)
	#test_genes = get_test_gene_names(test_file)
	#data_genes=find_data_genes(training_genes, test_genes)
